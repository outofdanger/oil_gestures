...
# MediaPipe hand skeleton connectivity (21 joints, 21 bones). Each tuple is an
# undirected bone (parent, child). This is the spatial graph used to build the
# adjacency matrix for graph models such as ST-GCN.
